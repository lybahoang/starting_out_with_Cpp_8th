...
Employee::Employee()
{
    ...
    hireDate = DEFAULT_DATE;
}

/**
 * Constructor. The constructor accepts arguments for the employee's name, number, and hire
 * date and then assigns them to appropriate member variables.
